    ...
    const columns = [
...

        {
            ...
            renderCell: (params) => {
                ...
                return (
                    <>
                        <IconButton aria-label="delete" size="large" color="primary" onClick={() => navigate(`${params.row.id}`)}>
                            <EditIcon fontSize="inherit" />
                        </IconButton>
                        <IconButton aria-label="delete" size="large" sx={{ color: 'red', display: "none" }} disabled onClick={() => handleDelete(params.row.id)}
                        >
                            <DeleteIcon />
                        </IconButton>
